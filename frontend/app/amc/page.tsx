    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-[11px] text-vodacom-muted mt-0.5">Track hardware and server servicing agreements</p>
        </div>
        <Link
          href="/amc/new"
      ...
      <Table headers={['Contract #', 'Client Company', 'Coverage Start', 'Coverage End', 'Contract Amount', 'Status', '']}>
        {filteredAmcs.map((amc: any) => (
          ...
          >
            ...
            <td className="px-6 py-4">
              <Badge variant={amc.status === 'active' ? 'success' : 'danger'}>{amc.status}</Badge>
            </td>
